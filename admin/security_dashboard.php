...
<body>
    <div class="container">
        ...
        <div class="actions">
            ...
            <?php endif; ?>
            <a href="advanced_security_monitoring.php" class="btn btn-primary">🔧 Advanced Security Dashboard</a>

            <a href="unified_dashboard.php" class="btn btn-primary">🏠 Back to Admin Dashboard</a>
        </div>
